...
namespace Swag\SaasConnect\Test\Storefront\Subscriber;
...
class StorefrontRenderEventSubscriberTest extends TestCase
{
    ...
    {
        $this->loadAppsFromDir(__DIR__ . '/../_fixtures/noThemeNoCss', false);

...
namespace Swag\SaasConnect\Test\Core\Content\App\Subscriber;
...
use Swag\SaasConnect\Core\Content\App\Subscriber\CustomFieldProtectionSubscriber;
...
class CustomFieldProtectionSubscriberTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->appRepo = $this->getContainer()->get('saas_app.repository');
    }
    ...
    public function testOnlyAppsCanWriteCustomFields(): void
    {
        ...
        $this->authorizeBrowserWithIntegration($client, $appId);
    ...
    public function authorizeBrowserWithIntegration(KernelBrowser $browser, string $appId): void
    {
